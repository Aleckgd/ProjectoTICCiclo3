package servlets;
	...
	public class ServletUsuarioRegister extends HttpServlet {
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			boolean tipo_usuario = Boolean.parseBoolean(request.getParameter("tipo_usuario"));
			
			String result = usuario.register(username, contrasena, nombre, apellidos, telefono, email, direccion, cant_donada, tipo_usuario);
